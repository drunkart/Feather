    ...
    shell: {
      browserify: {
        ...
        command: grunt.option('target') === 'dev'
                ? './node_modules/browserify/bin/cmd.js -r ./lib/bitcoinjs/index.js > public/js/lib/bitcoinjs.js | ./node_modules/browserify/bin/cmd.js -r ./lib/onenamejs/index.js:onenamejs > public/js/lib/onename.js'
