...
var onename    = require('./controllers/onename_api.js');
...
module.exports.create = function (express, db, websocket, insight) {
  ...
  var onenameController = new onename.OnenameController(
    '/api/dev/onename', express, '424b0b355e98dc151c72c3a9e53d6425', '1cae2f3666daf1d1804009129b6488eb44a0d0bafd73f625c8eadafcc0427d99'
  );
  ...
  express.get('/api/wallet/getFTC', walletController._emailtoFTC.bind(walletController));
  ...
  //Onename:
  express.get('/api/Onename/searchUser', onenameController._search.bind(onenameController));
  express.get('/api/Onename/getFTC', onenameController._getftc.bind(onenameController));
  express.post('/api/Onename/createUser', onenameController._create.bind(onenameController));
