...
DB.prototype = {
  ...
  saveMessage: function(data, callback) {
      console.log("From saveMessage")

      console.log(data.body.txid)
      this.redis.hmset(data.body.txid, data.body, function(callback) {
          console.log(callback)
      })
      this.redis.hmget(data.body.txid, 'message', function(error, response) {
          console.log(error)
