...
OnenameClient.prototype.hello = function(email) {
...
OnenameClient.prototype.emailSearch = function(username, callback) {
    test('GetUsers', function(t) {
        t.plan(1)
        this.searchUsers(username, function(err, users) {
            t.ok(users)
